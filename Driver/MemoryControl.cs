...
1	0002	initobj	Program/req
2	0008	ldloca.s	V_3 (3)
3	000A	ldarg.1
4	000B	stfld	uint32 Program/req::ProcessId
5	0010	ldloca.s	V_3 (3)
6	0012	ldarg.2
7	0013	call	native int [mscorlib]System.IntPtr::op_Explicit(int32)
8	0018	stfld	native int Program/req::Address
9	001D	ldloca.s	V_3 (3)
10	001F	ldc.i4.4
11	0020	stfld	uint32 Program/req::Size
12	0025	ldloc.3
13	0026	stloc.0
14	0027	ldc.i4.0
15	0028	stloc.1
...
21	0033	ldloc.0
22	0034	call	int32 [mscorlib]System.Runtime.InteropServices.Marshal::SizeOf<valuetype Program/req>(!!0)
23	0039	ldloca.s	Request (0)
24	003B	ldloc.0
25	003C	call	int32 [mscorlib]System.Runtime.InteropServices.Marshal::SizeOf<valuetype Program/req>(!!0)
26	0041	ldloca.s	bytesRet (2)
27	0043	ldsfld	native int [mscorlib]System.IntPtr::Zero
28	0048	call	bool Program::DeviceIoControl(native int, uint32, valuetype Program/req&, uint32, valuetype Program/req&, uint32, uint32&, native int)
29	004D	brfalse.s	35 (005D) ldstr "Error code: "
30	004F	ldloc.0
31	0050	ldfld	native int Program/req::Response
